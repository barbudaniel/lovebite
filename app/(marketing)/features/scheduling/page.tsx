    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
          ...
          <motion.div 
            className="absolute top-20 left-1/3 w-96 h-96 bg-emerald-100/50 rounded-full blur-3xl"
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div 
              ...
              className="w-20 h-20 bg-emerald-100 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg shadow-emerald-200/50"
            >
            ...
            >
              Stop juggling multiple apps. Queue your content across all platforms from one simple dashboard and let Lovdash handle the posting.
            </motion.p>
            ...
            >
              <Button asChild size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-full px-8 shadow-lg shadow-emerald-500/25">
                <Link href="/#cta">
                  Try Scheduling
            ...
            >
              <p className="text-sm text-slate-500 mb-4">Schedule to all your platforms</p>
              <PlatformLogosRow 
        ...
        <section className="py-16 bg-gradient-to-br from-emerald-500 to-teal-500">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Ready to automate your posting?</h2>
            <p className="text-white/80 mb-8">Set up your queue once and let Lovdash handle the rest.</p>
