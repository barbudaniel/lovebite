  ...
  sashalorenz: {
    ...
    links: [
      ...
      },
      {
        ...
        label: "XLoveCam",
        sub: "Watch me live & exclusive shows",
        href: "https://www.xlove.com/en/model/sashalorenz/",
        iconType: "video",
        iconColor: "text-pink-500",
      },
      {
      ...
      },
      {
        ...
        label: "BongaCams",
        sub: "Live streaming & shows",
        href: "https://bongacams.com/profile/sashalorenz",
        iconType: "video",
        iconColor: "text-orange-500",
      },
      {
  ...
  lustyfantasy: {
    ...
    links: [
      ...
      },
      {
        ...
        label: "Stripchat",
        sub: "Live shows & private sessions",
        href: "Https://stripchat.com/_lustyfantasy_",
        iconType: "video",
        iconColor: "text-purple-500",
      },
      {
    ...
    links: [
      {
        ...
        label: "OnlyFans",
        sub: "Exclusive content just for you ✨",
        href: "https://onlyfans.com/rinathequeen",
        pill: "FREE",
        pillColor: "bg-sky-100 text-sky-600",
        iconType: "crown",
        iconColor: "text-sky-500",
      },
      {
        ...
        label: "Fansly",
        sub: "Exclusive content just for you ✨",
        href: "https://fans.ly/RinaTheQueen",
        pill: "FREE",
        pillColor: "bg-sky-100 text-sky-600",
        iconType: "crown",
        iconColor: "text-sky-500",
      },
      {
        ...
        label: "Loyalfans",
        sub: "Exclusive content just for you ✨",
        href: "https://www.loyalfans.com/rinnaqueenie",
        pill: "FREE",
        iconType: "heart",
        iconColor: "text-rose-500",
      },
      {
        ...
        label: "LiveJasmin",
        sub: "Live shows & private sessions",
        href: "https://www.livejasmin.com/en/girls#!chat/RinnaQueenie",
        iconType: "video",
        iconColor: "text-purple-500",
      },
      {
        ...
        label: "Chaturbate",
        sub: "Watch me live",
        href: "https://chaturbate.com/RinaTheQueen/",
        iconType: "video",
        iconColor: "text-orange-500",
      },
      {
        ...
        label: "XLoveCam",
        sub: "Live streaming & shows",
        href: "https://www.xlove.com/en/model/rinaqueenie/?x-offline=1",
        iconType: "video",
        iconColor: "text-orange-500",
      },
      {
        ...
        label: "Skyprivate",
        sub: "Live streaming & shows",
        href: "https://profiles.skyprivate.com/models/22r8b-rinnaqueenie.html",
        iconType: "video",
        iconColor: "text-orange-500",
      },
    ],
